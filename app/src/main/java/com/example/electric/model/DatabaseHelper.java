...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public long addCustomer(Customer customer) {
        ...
        if (customerId != -1) {
            ...
            Log.d("DatabaseHelper", "Customer added with ID: " + customerId);
        }
    ...
    public boolean deleteCustomer(int id) {
        ...
        if (rowsDeleted > 0) {
            ...
            Log.e("DatabaseHelper", "No rows deleted for ID: " + id);
            return false;
        }
    }
        ...
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                ...
                if (columnIndex != -1) {
                    ...
                    Log.e("DatabaseHelper", "Column 'UNIT_PRICE' not found in ElectricUserType table.");
                }
            }
            cursor.close();
        }
